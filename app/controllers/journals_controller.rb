class JournalsController < ApplicationController
  ...
  def index
    ...
    render json: { journals: journals, total_journals: current_user.journals.length, current_user: current_user.username }
  end
  ...
  def journal_params
    params.require(:journal).permit(:title, :body, :user_id, :category)
  end
end
