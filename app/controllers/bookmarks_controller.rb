class BookmarksController < ApplicationController
  ...
  def index
    ...
    render json: { bookmarks: bookmarks, total_bookmarks: current_user.bookmarks.length, current_user: current_user.username }
  end
  ...
  def bookmark_params
    params.require(:bookmark).permit(:title, :description, :url, :user_id, :category)
  end
end
