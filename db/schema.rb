...
ActiveRecord::Schema.define(version: 20_200_720_035_656) do
  ...
  create_table 'category_joins', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[categorizable_type categorizable_id], name: 'index_category_joins_on_categorizable_type_and_categorizable_id'
